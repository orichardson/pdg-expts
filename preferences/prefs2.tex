...
\begin{document}
	...
	The variables $X$ and $Y$ are perfectly well-defined, and don't vary with time\footnote{which is already more than can be said for most variables that people care about --- `nutritious', `inoffensive', and `affluent' are moving targets}, and yet
