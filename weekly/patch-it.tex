...
\begin{document}
	...
	\textbf{My Thoughts.}
	This is pretty clearly enough to get around the problem in section 1. However, it is still a stronger extra assumption than required: all of the cases in \cref{sec:cases-works} are covered by maximum entropy alone, without this extra assumption that brings in a lot of causal information.
