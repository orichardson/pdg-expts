...
%oli24: added, and then thought better of it.
% , although there are significant barriers to replacing a PDG with a factor graph.
.
...
our assumption that $\alpha = \mathbf 1$, making it our only result that does not
...
The cpds of a PDG traightforwardly constitute the data of a factor graph,
and so  it natural to wonder how the semantics of a PDG compare to 
simply treating them as factors. To answer this question, we start by making
...
%oli24: added
though in its role here as a left inverse of \cref{def:wfg2pdg}, chosing either would suffice.
...
% They have a number of advantages of other graphical representations:
...
this is captured by the terms $\Inc$ and $\IDef{}$
 ...
 %oli24:added 
	Furthermore, the fact that a PDG has two sets of weights allow a modeler to
