...
%OMG THIS WORKS
\newcommand\smallt[1]{\text{\footnotesize#1}}
...
\newenvironment{idxmatphant}[4][\color{gray}\smallt]{%
	\def\idxstyle{#1}
	\def\colitems{#3}
	\def\rowitems{#2}
	\def\phantitems{#4}
...
\newenvironment{idxmat}[3][\color{gray}\smallt]
	{\begingroup\idxmatphant[#1]{#2}{#3}{#3}}
	{\endidxmatphant\endgroup}

\newenvironment{sqidxmat}[2][\color{gray}\smallt]
