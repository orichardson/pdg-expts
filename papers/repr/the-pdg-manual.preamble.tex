...
\newcommand{\none}{\varobslash}
\newcommand{\ed}[3]{#2%
	\overset{\smash{\mskip-5mu\raisebox{-1pt}{$\scriptscriptstyle #1$}}}{\rightarrow} #3}
...
\usepackage[framemethod=TikZ]{mdframed}
	...
	% add theorems to table of contents
	\def\thmTOCadd{\ifx\thmt@optarg\@empty
		...
		\else\addcontentsline{toc}{subsubsection}{%
			\texorpdfstring{
			 	\makebox[3cm][r]{\color{gray}{\it\thmt@thmname}~%
