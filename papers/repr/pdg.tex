...
%	\tableofcontents
	...
	Most graphical models eliminate where possible the possibility of inconsistency by fiat, so as to better represent probability distributions, making them poorly suited to representing inconsistent belief states.
