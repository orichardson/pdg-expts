...
%  - Graph union.
	...
	Being able to restrict your knowledge and look at a local picture may be a nice property, but a much more compelling reason to \MNs\ is their ability to aggregate knowledge from different places on a single map.
