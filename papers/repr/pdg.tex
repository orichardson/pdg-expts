...
%\includecomment{quickdefn}
%\includecomment{fulldefn}
...
%oli2: edited.
Bayesian networks (BNs), factor graphs, conditional versions of both, and extensions \parencite[see]{koller2009probabilistic}.
%oli3: I now agree that this needs to be shorter, with fewer citations.
%unifications of 
