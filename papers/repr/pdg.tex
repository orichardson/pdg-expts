...
%	Interpreting arrows this way has numerous related benefits: one of them is that 
	...
	\begin{example}
		\todo{Choices include: student plate model, coin \& experiences, model learning}
	\end{example}
...
%	We give the definition below for the finite case.  
	...
	which would be interpreted as a single table $\Pr(C\mid A, B)$ in a BN, would be two separate tables $\Pr(C \mid A)$ and $\Pr(B \mid A)$ in a \MN. We now give two 
...
%	\section{Semantics}\label{sec:semantics}
	...
	\begin{defn}
		Let $M \!=\!\mnvars[]$ and $M'$ be \MNs\ with \todo{I forget where this was going}
	\end{defn}
