...
%approaches.  
Bayesian networks (BNs), factor graphs, and Markov random fields.
...
But our approach to modeling inconsistency has many other advantages.  In particular,
...
%oli1: why should it here? We haven't fully explained anything yet. I mention it again when I the union precisely.
	such as manifolds \cite[p.12]{atlases} and sheaves, in which multiple restricted pictures can be glued together to form something with global structure.
