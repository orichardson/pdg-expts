...
%			\end{tikzpicture}
		...
		\todo{wrap this up, discuss (2) and (3). }
		\todo{Make the case for}
...
%	\end{defn}
	...
	From the two special cases of $\dcap$ discussed above, one can see that adding new links, (which we will see correspond to observations in \cref{sec:belief-update}), cuts down the set of possible distributions, just like conditioning, and adding new variables to a consistent model freely increases the number of valid distributions like one would expect.
