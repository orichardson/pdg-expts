...
%oli22: enabling subsection numbers (0: no numbers, 1: section, 2: subsection)
...
%oli22: but it helps me edit so I'm reenabling it until later
%FIXME
\usepackage{hyperref}
...
%oli22: macros for weighted factor graphs and PDGs
...
%oli22: softening:
	...
	%oli22: I still would defend this, but let's not go there right now.
...
%oli22: was extremely tricky to read and edit in its fragle run-on-sentence form. I
...
%oli22: edited and aadded back an old proposition to tell story. 
...
%oli22: here's an excellent example of why I dislike the notation
...
%}%
%oli22: rewrite paragraph continue the train of thought
...
%oli22*: this is the oposite of what we wanted to say.
