...
for some $\lambda_\ssymb, \lambda_\dsymb > $ with $\lambda_\ssymb + \lambda_\dsymb = 1$.
...
% \vspace{-2ex}
 ...
 is proportional the $\lambda$-weighted geometric mean of $s$ and $d$.
...
It seems that our approach, in addition to a unified view of standard loss functions, can also suggest more appropriate loss functions in practical situations.
...
Many thanks to my advisor, Joe Halpern, for his generous support, and for valuable criticism of many drafts. Thanks as well to the reviewers, who pushed for me to include more discussion on the confidence parameters, and \Cref{sec:datsim}.
