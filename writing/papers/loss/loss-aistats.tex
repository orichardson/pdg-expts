...
\subsubsection{Details for Claims made in \texorpdfstring{\Cref{sec:reverse-engineer}}{Section 8} }
% \def\Truth{{\tt T}}
% \def\trut{{\tt t}}
% \def\truf{{\tt f}}
...
$ \log \Ex_{x\sim p} \exp( c(x)) $, and that the optimal distribution would not have been $p(X)$. 
