...
We generally conflate a cpd's symbol with its edge label,
%oli3:
% so we draw
% and draw
% drawing
...
% No matter how 
Because $f$ is deterministic, using codes optimized for $f$ to express $(x,y)$ such that $y \ne f(x)$ is not just expensive, it is impossible---no matter how much inefficiency you're willing to tolerate. 
