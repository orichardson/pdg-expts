...
To summarize: while model inconsistency generates appropriate loss functions,
...
Reverse-enerineering a loss may require making questionable modeling choices with absolute certainty, resulting in brittle models with limited potential composition.
