...
information content (or \emph{surprise}  \cite{tribus1961information}) of the event $X \!\!=\! x$,
according to $p$. 
...
generative models \cite{deepgennotes}\cite{myung2003tutorial}.% 
...
every such `PDG divergence' (but not every limit point) is a (scaled) R\'enyi
divergence. 
