...
%have argued
argue
that the one might want to weight the reconstruction error \eqref{eq:rec} and
% the KL term
the `KL term'
...
Setting $\beta_p := \infty$ was necessary above, for example.
%TODO: For other\beta
%
...
\def\mypdg{\dg{S}\!\mathrm{upervised}\!\dg{L}\!\mathrm{earn}}
\[
	\mypdg
	:=
	% \aar*{
