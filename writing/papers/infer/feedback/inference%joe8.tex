...
%oli7: Un this paper we don't even have a notion of consistency at
%all; but th
...
%joe8: You may know in your head that you're hedging, but you haven't
%told the poor reader.  There's no point in adding this without
%explaining what you mean by "full consistency"; it will just
%confuse the reader.  "Consistent", on the other hand, is a standard
%English word.
%fully
consistent with
...
%oli7: well, as far as inference is concerned, this number is .  The
%fact that we end up computing it is purely incidental. I think it
%also makes the story better to say it this way. Reinstating what I
%had.
...
%oli7: I was hoping this would be clearer because I said it's a
...
%joe7:
%abiding by
%oli7: Why did you change this? It seems equivalent but
%blander. Generally, it seems every point where I'm most proud of the
%word choice, you edit to use only the most common words. I understand
%that your style is to write this way, but it's a joint effort, and I
%feel like my writing voice is being unnecessarily censored by these
%edits. 
...
%oli7: this makes it seem like we're defining something else, but this
%is what we were just talking about, and we need to name it.  
...
% distribution
 ...
 %oli7: agreed. It has been like this since I was asked to remove that
 %definition many drafts ago (%joe2 or so, I believe). I'll add the
 %definition back in.  
...
%oli7: I added this at the last second to signal that the experiments
%are not the focus here. I've accepted your deletion, since it will no
%longer necessary once the experiments have been cleaned up.  
...
%joe8: I assume you meant N, not n.  If not, you have to explain what
%n is here.  (See also next comment.)
%$\tilde O(n^{2.9})$.
$O(N^{2.872})$.  
%joe7*: this is not qu8te what your footnote says
%oli7: it's a weakening; I've just rounded up. O(n^2.872) \subset
%O(n^2.9).
%joe8: But by weakening this without explanation, you'll confuse the
%reader!
 But BNs, Factor Graphs, and nearly all graph problems can be solved
%joe8: Again, I assume that this should be N
...
%joe8*: I would just cut this; as we agree, it's a weak ending.  I
%don't think that saying it adds anything to the paper. Moreover, we
%need the space.
\commentout{
...
no ability to automatically recognize such situations). In any case,
