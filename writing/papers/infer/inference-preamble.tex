...
\relax %%%%%%%%% GENERAL MACROS %%%%%%%%
    ...
    \def\Rextge0{\Rext_{\scriptscriptstyle \ge 0}} % non-negative extended reals [0,\infty]
    \def\Rge0{\mathbb{R}_{\scriptscriptstyle \ge 0}} % [0, \infty)
...
\input{pdg-preamble-v2.tex} %% need PDG macros.
\relax %%% Macros specific to the inference paper
    \newcommand\bmu{\boldsymbol\mu}
    \newcommand\C{\mathdcal C}
    % \newcommand\minimize{\mathop{\text{\sf minimize}}\limits}
    % \newcommand\subjto{\text{\sf subject to}}
    % what a mess
    ...
    % \newcommand\minimize{\mathop{\textsf{\small minimize}}\limits}
    % \newcommand\subjto{\textsf{\small subject to}}
    % \newcommand\maximize{\mathop{\textsf{\small maximize}}\limits}
...
\relax %%%%% restatables and links
	...
	\makeatother
        ...
        \usepackage{cancel} %% to format proofs
...
\relax % Writing Tools
    ...
    %https://tex.stackexchange.com/questions/317801/dagger-footnote
