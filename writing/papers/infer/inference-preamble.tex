...
\relax %%% Macros specific to the inference paper
    ...
    % \newcommand\minimize{\mathop{\mathsf{minimize}}\limits}
    % \newcommand\subjto{\mathsf{subject~to}}
    \newcommand\minimize{\mathop{\text{\small\sf minimize}}\limits}
    \newcommand\subjto{\text{\small\sf subject to}}
    \newcommand\maximize{\mathop{\text{\small\sf maximize}}\limits}
