...
\relax %%%%%%%%%   PDG  MACROS   %%%%%%%%
	...
	% \newcommand\SDef{\mathit{S\mskip-3.5muD\mskip-2.5mue\mskip-1.5muf}} % new version of IDef
	% \newcommand\SDiff{\mathit{S\mskip-3.5muD\mskip-2.5mui\mskip-1.5muff}} % new version of IDef
	\newcommand{\SInc}{\mathit{S\mskip-2.5muI\mskip-3.5mun\mskip-1.7muc}} % new version of IDef
	% \newcommand{\ed}[3]{%
	% 	\mathchoice%
