...
%oli7: yes it is; as far as inference is concerned, this number is just a value that we end up calculating as we find a minimizer.  The fact that we end up computing it is purely incidental. I think it also makes the story better to say it this way. Reinstating what I had. 
