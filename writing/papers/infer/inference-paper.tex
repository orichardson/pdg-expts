...
Together, \cref{prop:cluster+idef,prop:cluster-small-gamma} show that each form of PDG inference we consider
%
can be written as a convex optimization problem with a
