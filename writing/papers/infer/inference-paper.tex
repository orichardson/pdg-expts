...
%oli5: de-emphasizing the algorithm.
...
\begin{lemma}
    ...
    \begin{align*}
        ...
        %     \limits_{\mathclap{\mat s \in \Rext^{3n}\!,\; \mat y \in \Rext^{m}}}
        %         ~~ \mat b^{\sf T} \mat y
        % \quad\text{\sf subject to}~~ \mat A^{\sf T} \mat y  +  \mat s = \mat c,~~\mat s \in (K^*_{\exp})^n
    \end{align*}
    can be 
