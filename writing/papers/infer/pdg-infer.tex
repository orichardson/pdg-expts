...
In the bounded tree-width setting, we can simply write all of the constraints together
...
% Because of the
 we note that from \Cref{prop:sementics-via-inconsistency}, it follows that this entire procedure is just minimizing the inconsistency of a single PDG $\aar{\dg M \bundle \mu}$, where $\mu$ has very high confidence.
