...
%oli9*: only for now. I want especially this first appendix in the arxiv version.
\discard{
...
method corresponding to problems \eqref{prob:joint-small-gamma} or \eqref{prob:cluster-small-gamma} --- rather, we have only implemented the concave-convex procedure, or CCCP \parencite{yuille2003concave}. 
