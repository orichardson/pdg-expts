...
%%oli26: I might not want to say this, because we're giving an exponential-memory
...
$\dg M'
%oli26: not sure which place I want to put the notation but both is overkill.
% keeping this here for now.
% := \dg M \cup (1 \xrightarrow{\delta_y} Y))
$. The distribution $\bbr{M'}^*$ turns out
to be the result of conditioning $\bbr{\dg M}^*$ on $X\!=\!x$.  
%
There is much more to be said here;
%especially regarding the role of $\alpha$, and its role in causal reasoning. 
...
%oli26: I want to convey that the parameters are a natural constant, as opposed to being chosen for the particular factor graph.
...
%oli26: can't decide between "unatural properties" and "problematic behavior"
