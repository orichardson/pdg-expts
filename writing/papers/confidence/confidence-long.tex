...
$[\frac{\partial U}{\partial \theta_1}, % \ldots, \frac{\partial U}{\partial \theta_i},
...
\begin{examplex}{Gaussian NGD}{}
    ...
    \[
        ...
        \begin{bmatrix}
            \frac{x-\mu}{\sigma} \\ \frac {-\sigma^2 + (x-\mu)^2}{2 * \sigma^4}
        \end{bmatrix}
        =
        \begin{bmatrix}
            x-\mu \\ (x-\mu)^2 - \sigma^2
    ...
    \begin{itemize}
        ...
        \item $\displaystyle F^t_\mu(\mu, \sigma_0^2) = (\mu, \frac{1}{t + \frac{1}{\sigma_0^2}}.$\\
        So, after observing the value of $x$ you already believe to be the mean $\mu$ with confidence $t$, you arrive at a variance equal to the harmonic mean of your initial variance, and $\frac1t$.
        So, in this setting, confidence is roughly the inverse of variance.
    \end{itemize}
\end{examplex}
