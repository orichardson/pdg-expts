...
Thus, functions satisfying these axioms are defined up to parameterization
of intermediate confidences. For this reason, we give them a special name
% Together, these axioms allow us to define an update rule, by:

\begin{defn}
	A function $F: \Phi \times [0,1] \times \Theta \to \Theta$ 
	satisfying \cref{ax:zero,ax:idemp,ax:cont,ax:seq-for-more,ax:diffble} is 
