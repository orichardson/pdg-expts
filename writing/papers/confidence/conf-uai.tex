...
% \section{A Formalism for Updates}
\section{Update Functions
    and their Path Representations}
\input{sections/update-formalism}

% \section{Additive Updates, and their
%     Flow Representations}
% \input{sections/flow-repr.tex}

% \section{Differentiable Updates, and their
%     Vector Field Representation}
% \section{Additive Differentiable Update Functions, and their
%     Vector Field Representation}
\section{Additive Representations of Confidence, and their
    Vector Fields}
