...
\begin{example}
    ...
    \begin{enumerate}
        ...
        \item Starting from any strictly positive distribution, one can get to any distribution at all. In general, it will turn out that if $\mu \ll \nu$, there is a sequence of updates that will take you take .  
    \end{enumerate}
