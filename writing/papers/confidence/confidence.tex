...
(and without a notion of confidence, we can't very well specify how much to incorporate), then it should be the case that a second update with the same information should not affect the belief state.
...
\begin{CFaxioms}
    ...
    idempotent ($F_\phi \circ F_\phi = F_\phi$)
\end{CFaxioms}
