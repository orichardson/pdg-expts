...
\begin{figure}
	...
	\hfill\vline\hfill
	\subcaptionbox{ One translation of $\D$ to a PDG, in which the  \label{subfig:indexed}}{
		\begin{tikzpicture}[baseline=0]
...
\begin{fact}[\cite{abiteboul1995foundations}]
\end{fact}


Let $\Varis$ be a set of variable symbols.

\begin{defn}[tableau queries]
...
\begin{defn}[logical semantics for databases]
