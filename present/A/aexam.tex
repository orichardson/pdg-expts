...
% Details of PDG definition componnets & subsets + Category Theory
{
    ...
    \begin{frame}
        \usebeamercolor[fg]{normal text}
        What do you do with diagrams? Take {\color{blue!50!gray!60!white}limits}  colimits.
        ...
        For all of $\dg M$:
        % \begin{prop}
            \[ \lim \dg M =  \mathrm{Verts}(\, {\color{gray!90!black}\underbrace{\usebeamercolor[fg]{normal text}%
                    \,\mathbb L \dg M \,%
                }_{\mathclap{\substack{\text{Locally Consistent Polytope}\\\text{(state for belief propagation)}}}} } \,)  \] 
        % \end{prop}
    \end{frame}
}
